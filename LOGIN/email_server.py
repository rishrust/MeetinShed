...
def meeting_generated(user_email,title,date,share_link):
    ...
    msg='Your Meeting '+str(title)+' on '+str(date)+' is scheduled, now awaiting for recievers conformation. Share this link with other person to invite them on meeting '+str(share_link)+' Meeting genrated on '+str(datetime.now)
    sender='meetinshed@gmail.com'  #write email id of sender
